...
public class Terrain : IActor
{
    ...
    private Coordinates _previousPosition = new(-1, -1);
    ...
    private bool UpdateTileMap { get; set; }
    ...
    {
        if (terrainType is TerrainType.Water or TerrainType.WaterLeftEdge or TerrainType.WaterRightEdge)
        {
